  ...
  return (
    <div className="flex flex-col items-center my-12 mt-6 w-full">
      <div className="flex text-gray-700 w-min">
        <div className="h-12 w-12 mr-2 flex justify-center items-center rounded-2xl bg-white dark:bg-lightDark cursor-pointer">
          <ChevronLeftIcon className="w-5 hover:text-[#1C92FF] duration-300 stroke-2 dark:text-white" />
        </div>
        <div className="flex items-center h-12 font-medium rounded-2xl bg-white dark:bg-lightDark dark:text-white w-full lg:w-9/12 justify-around">
        ...
        <div className="h-12 w-12 ml-1 flex justify-center items-center rounded-2xl bg-white  dark:bg-lightDark dark:text-white cursor-pointer">
