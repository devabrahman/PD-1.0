  ...
  return (
    <Menu as="div" className="relative z-20 inline-block text-left">
      ...
      <MenuTransition as={Fragment}>
        <Menu.Items className="absolute left-0 mt-2 z-20 w-60 origin-top-left rounded-md overflow-hidden bg-white shadow-lg ring-0 focus:outline-none pt-3 pb-4">
          <div className="px-6">
            ...
            <select
              name=""
              id=""
              className="bg-transparent border border-gray-300 rounded-lg px-2 py-2 w-full mt-2 text-xs outline-none focus:outline-none focus:ring-0">
