...
const Notification = () => {
  return (
    <Popover className="relative">
      <Popover.Button>
        <div className="relative bg-white transform-gpu hover:scale-95 transition-all duration-150 border border-gray-50 table-shadow rounded-xl p-2.5 grid place-content-center cursor-pointer grid-cols-2 gap-x-1.5">
          <NotificationIcon />
      ...
      <Popover.Panel className="absolute min-w-max z-10 -right-2 mt-1.5 bg-white p-4 pl-8 rounded-3xl input-back-box-shadow">
        <ul className="space-y-2 list-disc">
          <li className="flex gap-[14px] items-center">
            ...
            <div className="w-7 h-7 rounded-full bg-gray-50 position-center self-start cursor-pointer mt-2">
