      ...
      <div className="flex">
        ...
        <form className="w-full h-auto mx-5">
          <div className="mb-4 mx-0">
            ...
            <input
              type="text"
              className="rounded-2xl flex justify-center items-center border border-primary bg-primary bg-opacity-10 p-3 font-montserrat text-sm w-10/12"
              required
              placeholder="Categories Name"
            />
            <input
              type="text"
              className="rounded-3xl flex justify-center items-center border border-primary bg-primary my-5 bg-opacity-10 p-3 font-montserrat text-sm w-5/12"
              required
              placeholder="Slug"
            />
          </div>
