...
const ProductTag = () => {
  return (
    <div className="w-full rounded-xl input-accent-box-shadow mt-5 px-5 py-3 bg-white dark:bg-dark">
      ...
      <div className="flex mt-3 flex-wrap gap-x-2 gap-y-2">
        <div className="bg-gray-50 dark:bg-lightDark rounded-md flex items-center h-8 shadow-sm">
