...
import tagPic from 'assets/Images/common/CategoryPic.png';
import { Dialog } from '@headlessui/react';

const EditTag = ({ isOpen, setIsOpen }) => {
  return (
        ...
        <Dialog.Panel className="w-full max-w-2xl transform overflow-hidden rounded-2xl bg-white dark:bg-lightDark p-6  shadow-xl transition-all text-center">
          <form className="mx-0 my-0">
            ...
            <section className="flex mb-16">
              <img src={tagPic} className="w-60 h-44" />
              <form className="mt-6 space-y-8 w-full">
                <div className="mb-4 mx-0">
                  ...
                  <input
                    type="text"
                    className="rounded-xl flex justify-center dark:bg-lightDark dark:text-white items-center border border-[#B9B9B9]/50 italic p-4 font-montserrat text-sm w-full input-box-shadow"
                    required
