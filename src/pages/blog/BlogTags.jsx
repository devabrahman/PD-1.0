      ...
      <Layout title="Blog Tags" padding="p-0 sm:px-10 sm:py-8">
        ...
        <div className="relative overflow-x-auto shadow-md shadow-blue-50 dark:shadow-gray-900 sm:rounded-lg mt-6">
          <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead className="text-xs text-gray-700 dark:text-white uppercase bg-white dark:bg-dark border-b dark:border-gray-600">
              <tr>
                ...
                <th scope="col" className="px-6 py-4 text-gray-700 dark:text-white">
                  Tag
                </th>
                <th scope="col" className="px-6 py-4">
                  <div className="flex items-center">
                    <p className="text-gray-700 dark:text-white">Description</p>
                    <ChevronUpDownIcon className="h-[18px] w-4 bg-blue-50 dark:bg-lightDark dark:text-white hover:bg-blue-400 hover:text-white ml-1.5 rounded-sm cursor-pointer" />
                  </div>
                </th>
                <th scope="col" className="px-6 py-4">
                  <div className="flex items-center">
                    <p className="text-gray-700 dark:text-white">Products</p>
                    <ChevronUpDownIcon className="h-[18px] w-4 bg-blue-50 dark:bg-lightDark dark:text-white hover:bg-blue-400 hover:text-white ml-1.5 rounded-sm cursor-pointer" />
                  </div>
                </th>
                <th scope="col" className="px-6 py-4">
