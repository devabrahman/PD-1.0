      ...
      <div className="w-[492px] mx-auto py-5">
        ...
        <form className="w-full">
          <div className="flex items-center gap-7 mb-5">
            <div>
              <label className="text-sm text-[#2B3674] font-medium mb-3 block" htmlFor="firstName">
                First Name
              </label>
              <input
          ...
          <div className="mb-5 w-full">
            <label className="text-sm text-[#2B3674] font-medium mb-3 block" htmlFor="phoneNumber">
              Contact Number
            </label>
            <input
              className="w-full border border-[#E0E5F2] rounded-2xl px-6 py-4 placeholder:text-[#A3AED0] placeholder:text-sm"
