...
import Error404Icon from 'components/SVGIcons/Error404Icon';
...
const Error404 = () => {
  return (
    <>
      <div className="w-full h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0 dark:bg-dark">
