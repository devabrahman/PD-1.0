          ...
          <div className="flex justify-between">
            ...
            <div className="w-[180px]">
              ...
              <div className="grid">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[#536571] text-sm font-medium">Generate order id</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[#536571] text-sm font-medium">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[#536571] text-sm font-medium">Order delivered</p>
            ...
            <div>
              ...
              <div className="border border-[#b9b9b94f] rounded-xl w-[370px] h-20 flex items-center justify-between px-6 py-7">
                ...
                <div className="mr-6">
                  <p className="flex items-center font-medium text-[#536571] text-lg">
