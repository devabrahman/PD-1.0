        ...
        <form className="w-full flex gap-12 pt-14">
          <section className="w-3/4">
            ...
            <div>
              ...
              <input
                className="w-full dark:border-darkBorder rounded-xl px-4 dark:bg-lightDark py-2 border border-gray-200 outline-none focus:ring-0 focus:outline-none"
                type="text"
                name="title"
              ...
              <div className="grid grid-cols-3 items-center gap-14">
                ...
                <div className="col-span-1 my-5">
                  ...
                  <input
                    ...
                    name="quantity"
                    id="quantity"
                    className="border pl-3 border-gray-200 dark:border-darkBorder bg-white dark:bg-lightDark py-1.5 rounded-lg w-full pr-1.5 mt-2"
                    value={3}
                  />
                </div>
              </div>
