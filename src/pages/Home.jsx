import { CalendarDaysIcon, CheckIcon, ChevronUpIcon, TruckIcon } from '@heroicons/react/24/outline';
    ...
    <Layout title="Dashboard" padding="px-8 py-8">
      <main className="py-5 dark:bg-dark px-3 sm:px-0">
        ...
        <section className="grid grid-cols-12 gap-6 mt-8">
          <div className="col-span-12 sm:col-span-9 bg-white p-5 rounded-xl">
